const SETTORI = {
  ...
  carburanti: {
    label: 'Stazione di Servizio / Carburanti / Automotive',
    categorie_contenuto: [
      'Carburanti e prezzi alla pompa (offerte e novità)',
      'AdBlue e prodotti certificati (qualità, analisi, certificati)',
      'CarWash / autolavaggio (programmi, prima e dopo)',
      "Prodotti e accessori auto (olio, batterie, ricambi)",
      "Consigli per l'automobilista (manutenzione, risparmio carburante)",
      'Servizi per aziende e autotrasportatori (forniture, extrarete)',
      'Il team al lavoro / dietro le quinte',
      'Le sedi e i punti vendita',
      'Promozioni, carta fedeltà e carte carburante',
      'Sicurezza e qualità (certificazioni, controlli, conformità)',
      "Mobilità e novità (elettrico, GPL, metano, additivi)",
      'Orari, festività e informazioni utili'
    ],
    domanda_prodotti: 'Quali carburanti, prodotti e servizi offrite?',
    help_prodotti: 'Es: benzina, diesel, AdBlue, GPL, metano, carwash, olio, batterie, accessori auto/camion, ricarica elettrica... (uno per riga)',
    domanda_eventi: "Ci sono periodi, ricorrenze o iniziative particolari durante l'anno?",
    help_eventi: 'Es: esodo estivo, controlli pre-vacanze, cambio gomme stagionale, promozioni carburante, fiere autotrasporto...',
    foto_specifiche: [
      'Foto della stazione / pompe di rifornimento',
      "Foto dell'area carwash / autolavaggio",
      'Foto dei prodotti (AdBlue, olio, accessori)',
      'Foto del team / operatori',
      'Foto delle sedi / insegne'
    ],
    aggettivi_extra: ['Efficiente', 'Certificata', "Vicina all'automobilista", 'Sempre operativa', 'Di fiducia'],
    domande_extra: [
      { tipo: 'choice', titolo: 'Che tipo di attività siete principalmente?', opzioni: ['Stazione di servizio / Distributore carburanti', 'Autolavaggio / CarWash', 'Stazione di servizio con carwash e shop', "Agenzia / deposito carburanti (forniture all'ingrosso)", 'Officina / Gommista / Ricambi auto'] },
      { tipo: 'checkbox', titolo: 'Quali carburanti e prodotti energetici trattate?', opzioni: ['Benzina', 'Diesel / Gasolio', 'AdBlue', 'GPL', 'Metano', 'Diesel premium / additivato', 'Ricarica elettrica', 'Lubrificanti / Olio'] },
      { tipo: 'checkbox', titolo: 'Quali servizi offrite oltre al rifornimento?', opzioni: ['Autolavaggio / CarWash', 'Self-service 24h', 'Shop / market', 'Vendita accessori e ricambi auto', 'Forniture aziende e autotrasportatori (extrarete)', 'Bar / ristoro', 'Aria e acqua / servizi gratuiti'] },
      { tipo: 'choice', titolo: 'Avete una carta fedeltà, convenzioni o carte carburante?', opzioni: ['Sì, carta fedeltà / raccolta punti', 'Sì, carte carburante per aziende', 'Convenzioni con aziende / flotte', 'No, ma vorremmo introdurle', 'No'] },
      { tipo: 'choice', titolo: 'Vendete prodotti certificati (es. AdBlue) con controlli di qualità?', opzioni: ['Sì, con analisi e certificati di ogni fornitura', 'Sì, prodotti certificati ma senza analisi interne', 'No, non trattiamo prodotti che richiedono certificazione'] }
    ]
  }
};
