// Generazione immagini AI via gemini-3.1-flash-image (Nano Banana 2).
// Override possibile con env GEMINI_IMAGE_MODEL (es. per tornare a
// gemini-2.5-flash-image o passare a gemini-3-pro-image / Nano Banana Pro).
// Differenze chiave da `gemini.js` (text):
//   - modello differente (gemini-3.1-flash-image)
