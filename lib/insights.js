...
// DEPRECAZIONE Meta (15/6/2026): l'intera famiglia `post_impressions*` è stata
// rimossa su TUTTE le versioni Graph API (#100 invalid metric). Il reach post
// ora è `post_total_media_view_unique` (singolare "view", verificato live);
// `post_impressions` non ha un rimpiazzo diretto → rimosso.
const FB_METRIC_MAP = {
...
// NOTA: `page_impressions` e `page_impressions_unique` sono state deprecate
// (deprecazione reach Meta del 15/6/2026, valida su TUTTE le versioni API →
// #100 invalid metric). Il reach ora è `page_total_media_view_unique`
// ("persone uniche che hanno visualizzato i contenuti della Pagina",
// period=day verificato live).
