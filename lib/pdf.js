...
function buildInsightsReportHtml(client, periodLabel, summary, history, topPosts, kpis) {
  ...
  const emcLogo = (barId, txtId, w, h) => `
    <svg width="${w}" height="${h}" viewBox="0 0 200 50">
      <defs>
...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  <div class="cover">
    <div class="cover-top">
      ${emcLogo('emcBarCov', 'emcTxtCov', 132, 33)}
      <div class="meta">
  ...
  ${!noData ? `<div class="section-h"><span class="num">02</span><h2>Andamento per canale</h2><span class="h-hint">I numeri di Facebook e Instagram</span></div>${fbCard}${igCard}` : ''}
  ...
  <div class="doc-footer">
    ...
    <div class="sign-card">
      ${emcLogo('emcBarFoot', 'emcTxtFoot', 96, 28)}
